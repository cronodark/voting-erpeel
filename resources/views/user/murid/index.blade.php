                    ...
                    <div class="col-lg-6 col-md-6">
                        <div class="text-white rounded text-center mb-4 votcard shadow-md bg-white p-4 pt-5">
                            ...
                            <button data-bs-toggle="modal" data-bs-target="#exampleModal{{ $k->id }}"
                                class="btn btn-primary fw-bolder px-4 fs-8 me-4"><span><i class="bi bi-pass-fill"></i></span> Misi</button>
                            <button class="btn btn-success fw-bolder px-4 fs-8"><span><i class="bi bi-clipboard2-check-fill"></i></span> Vote</button>
                        </div>
                    </div>
                @endforeach
            </form>
