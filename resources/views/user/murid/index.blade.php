    ...
    <div class="container-xl" style="padding-top: 5rem">
        ...
        <div class="row d-flex">
            ...
            <div class="col-lg-6 col-md-6">
                <form action="{{ route('user.murid.vote_ketua') }}" method="POST"
                    id="{{ $k->id }}">
                    @csrf
                    @method('PUT')
                        <div class="text-white rounded text-center mb-4 votcard shadow-md bg-white p-4 pt-5">
                        <img class="rounded-pill shadow-md p-2" src="{{ asset('assets/images/member-01.jpg') }}" alt="">
                        ...
                        <button data-bs-toggle="modal" data-bs-target="#exampleModal{{ $k->id }}" class="btn btn-primary fw-bolder px-4 fs-8 me-4">
